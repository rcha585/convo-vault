...
The project now has a v0.5.7 modified local backend rendering path:
...
- v0.5.7 modified keeps faithful export behavior, adds role-sequence diagnostics, and treats adjacent assistant turns as warnings rather than automatic deletions.

...
This is the v0.7.9 local backend rendering direction: the extension keeps the
...
The current `0.7.9` codebase can use Microsoft Edge as an independent backend
